...
> **Want these fixes now?** They are in the pre-release
> **[v1.0.6-pre4](https://github.com/mm5agm/Icom_Web_Control/releases/tag/v1.0.6-pre4)** —
...
> link. It is the v1.0.5 you already have plus the fixes below — but it is a
...
- **IWC now tells you *which* build you are running.** v1.0.6-pre1, pre2 and pre3 all displayed themselves as plain "v1.0.6" — in the title bar, on the About page, in the system tray and in the diagnostics you would paste into a bug report. There was no way for you to tell three different builds apart, and no way for me to tell from a report which one you were on. Pre-releases now show their full label, **v1.0.6-pre4**, everywhere the version appears. The update banner understands the difference too, so when the full v1.0.6 arrives you will be offered it rather than being left on a pre-release that looks like the same version.
