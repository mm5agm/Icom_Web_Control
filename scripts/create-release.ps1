...
Write-Host "  https://github.com/mm5agm/Icom_Web_Control/actions"  -ForegroundColor Yellow
Write-Host "  https://github.com/mm5agm/Icom_Web_Control/releases" -ForegroundColor Yellow
