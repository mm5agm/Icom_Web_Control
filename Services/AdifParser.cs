...
namespace Icom_Web_Control.Services
{
    ...
    /// fields IWC's memory-import feature cares about — FREQ, MODE, BAND,
    ...
    public static class AdifParser
    {
        ...
        /// <summary>
        /// Map an ADIF MODE string to one of IWC's mode names. ADIF uses a
        /// flat list of modes; IWC's "modes" include the upper/lower
