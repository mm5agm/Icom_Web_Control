...
namespace Icom_Web_Control.Services.Voice
{
    ...
    /// customised and the trigger-optional rule for bands/steps
    /// (<see cref="VoiceGrammar.TriggerOptionalCommands"/>).
    ///
    ...
    public static class VoiceHelpBuilder
    {
        ...
        private static readonly Dictionary<string, string> Labels = new()
        {
            ...
            ["AtuOn"]            = "Put the antenna tuner in line",
            ["AtuOff"]           = "Bypass the antenna tuner",
            ["AtuTune"]          = "Run an auto-tune cycle (say it again to stop one)",
